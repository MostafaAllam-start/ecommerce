                                                    ...
                                                    <div class="product-reviews">
                                                        <div id="product_comments_block_extra">
                                                            ...
                                                            <div class="comments_advices">
                                                                <a href="#" class="comments_advices_tab"><i class="fa fa-comments"></i></a>
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#reviews">Write Your Own
                                                Review<span class='count-comment'> {{$product->reviews->count()}}</span></a>
                                        </li>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="id_new_comment_form" method="post" action="{{route('products.reviews.store')}}">
                                                            @csrf
                                                    ...
                                                    <div class="product-cat-content">
                                                        <div class="category-title">
                                                            <div class="product-title" itemprop="name"><a
                                                                    href="{{route('products.details',$_product -> slug)}}">{{$_product -> name}}</a></div>

                                                        </div>
                                                        <div class="thumbnail-container">

                                                            <a href="{{route('products.details',$_product -> slug)}}"
