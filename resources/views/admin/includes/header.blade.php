            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  ...
                  <img  style="height: 35px;" src="{{asset('assets/admin/images/avatar.jpg')}}" alt="avatar"><i></i></span>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">{{getDefaultLanguage()}}</a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    ...
                                    <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        <div class="media">
                                            ...
                                            <span class="avatar avatar-sm avatar-away rounded-circle">
                                                <img src="{{asset('assets/admin/images/l/'.$localeCode.'.jpg')}}" alt="{{$properties['native']}}">
                                            </span>
                                            </div>
                                            <div class="media-body">
                                                <h6 style="margin-top:10px;">{{$properties['native']}}</h6>
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
