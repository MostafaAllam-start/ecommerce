                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> أضافه اسلايد
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> أضافة اسلايد جديد </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form dropzone"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> الصورة </h4>
...
@section('script')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles = {
            ...
            ,
            url: "{{ route('admin.sliders.save') }}", // Set the url
            success:
